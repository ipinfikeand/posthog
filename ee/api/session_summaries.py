...
class SessionSummariesViewSet(TeamAndOrgViewSetMixin, GenericViewSet):
    ...
    def search_summaries(self, request: Request, **kwargs) -> Response:
        ...
        # Check which sessions have full summaries in Postgres
        sessions_with_summaries = SingleSessionSummary.objects.summaries_exist(
            team_id=self.team.pk,
            session_ids=[seg.session_id for seg in deduped],
        )
