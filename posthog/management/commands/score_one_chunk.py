"""Manual smoke-test for the session interestingness scoring pipeline.
...
class Command(BaseCommand):
    ...
    def handle(self, *_args: Any, **options: Any) -> None:
        ...
        try:
            ...
            self.stdout.write(
                self.style.ERROR(
                    ...
                    "Run `pytest posthog/temporal/tests/session_replay/interestingness_scoring_sweep/test_sql_alignment.py` "
        ...
        for session_id, team_id, score in zip(df["session_id_v7"], df["team_id"], scores, strict=True):
