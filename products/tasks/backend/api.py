...
def task_visibility_q(user) -> Q:
    ...
    A task is visible if its creator matches the user, or if it has no
    ...
    `task.created_by` to mint OAuth tokens). Internal-API callers
    (service-to-service) are unrestricted within their team scope.
    """
