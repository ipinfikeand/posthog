...
@activity.defn(name="start_babysit_for_task")
def _mock_start_babysit(_input) -> None:
    pass


@activity.defn(name="send_heartbeat_to_babysit")
def _mock_send_heartbeat_to_babysit(_input) -> None:
    pass
        ...
        async with await WorkflowEnvironment.start_time_skipping() as env:
            ...
            async with Worker(
                ...
                activities=[
                    ...
                    _mock_cleanup,
                    _mock_start_babysit,
                    _mock_send_heartbeat_to_babysit,
                ],
