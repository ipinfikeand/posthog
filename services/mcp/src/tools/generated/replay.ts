...
import { SessionRecordingPlaylistsCreateBody, SessionRecordingPlaylistsListQueryParams, SessionRecordingPlaylistsPartialUpdateBody, SessionRecordingPlaylistsPartialUpdateParams, SessionRecordingPlaylistsRetrieveParams, SessionRecordingsDestroyParams, SessionRecordingsRetrieveParams } from '@/generated/replay/api'
...
const RecordingOrder = z.enum(["duration", "recording_duration", "inactive_seconds", "active_seconds", "start_time", "console_error_count", "click_count", "keypress_count", "mouse_activity_count", "activity_score", "recording_ttl"])
...
export const GENERATED_TOOLS: Record<string, () => ToolBase<ZodObjectAny>> = {
    ...
    'query-session-recordings-list': createQueryWrapper({ name: 'query-session-recordings-list', schema: AssistantRecordingsQuery, kind: 'RecordingsQuery', urlPrefix: '/replay', mcpVersion: 2 }),
}
