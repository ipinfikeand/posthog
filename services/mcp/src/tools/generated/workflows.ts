...
import { HogFlowsListQueryParams, HogFlowsLogsRetrieveParams, HogFlowsLogsRetrieveQueryParams, HogFlowsMetricsRetrieveParams, HogFlowsMetricsRetrieveQueryParams, HogFlowsRetrieveParams } from '@/generated/workflows/api'

const HogFlowsLogsRetrieveSchema = HogFlowsLogsRetrieveParams.omit({ project_id: true }).extend(HogFlowsLogsRetrieveQueryParams.shape)
...
const HogFlowsMetricsRetrieveSchema = HogFlowsMetricsRetrieveParams.omit({ project_id: true }).extend(HogFlowsMetricsRetrieveQueryParams.shape)
